from sqlalchemy import create_engine, String, Float, Integer, ForeignKey, Boolean, Text, DateTime,Unicode
...
engine = create_engine(f"postgresql+psycopg2://postgres:4102011@localhost:5432/online_restaurant", echo=False)
...
from online_restaurant_db import Base, engine
